...
export default Model.extend(Comparable, ValidationEngine, {
    ...
    showAudienceFeedback: computed("sentiment", function () {
        return (
            this.feature.get("audienceFeedback") && this.sentiment !== undefined
        );
    }),
    ...
    previewUrl: computed(
        ...
        function () {
            ...
            return this.get("ghostPaths.url").join(
                blogUrl,
                previewKeyword,
                uuid
            );
    ...
    pastScheduledTime: computed(
        ...
        function () {
            if (this.isScheduled) {
                ...
                let pastScheduledTime =
                    publishedAtUTC.diff(now, "hours", true) < 0;
    ...
    _getPublishedAtBlogTZ() {
        ...
        if (publishedAtBlogDate && publishedAtBlogTime) {
            ...
            if (
                publishedAtUTC &&
                publishedAtBlog.diff(
                    publishedAtUTC.clone().startOf("minutes")
                ) === 0
            ) {
    ...
    _setPublishedAtBlogStrings(momentDate) {
        if (momentDate) {
            ...
            this.set(
                "publishedAtBlogDate",
                publishedAtBlog.format("YYYY-MM-DD")
            );
